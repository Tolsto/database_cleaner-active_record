...
Gem::Specification.new do |s|
  ...
  s.description = "Strategies for cleaning databases using ActiveRecord. Can be used to ensure a clean state for testing."
  ...
  s.homepage = "http://github.com/DatabaseCleaner/database_cleaner-active_record"
  s.license = 'MIT'
